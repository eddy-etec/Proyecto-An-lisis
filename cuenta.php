                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Mi cuenta <br> <small>Vehículos subastados</small>
                        </h1>
                        <ol class="breadcrumb">
                          <li>
                            ...
                            while($row = $res->fetch_assoc()){
                              ...
                              if($res2->num_rows > 0){
                                while($row2 = $res2->fetch_assoc()){
                                  ...
                                  $catego_v = $row2["id_categoria"];

                                  //Inicia consulta de categoria del vehículo
                                  $result = $bd->select("SELECT * from categoria where id_categoria=$catego_v");
                                          ...
                                          <td width="180px">
                                            <center>
                                              <a href="<?php echo "subasta.php?id=$sub"; ?>">
                                                <img src="<?php echo "images/productos/$imagen_v";?>" style="height: 80px;">
                                              </a>
                                            </center>
                                          </td>
                                          <td><?php echo "<b class='text-success'>$marca_v</b>";?></td>
                  ...
                  <?php
                          ...
                          if($res->num_rows > 0){
                            while($row = $res->fetch_assoc()){
                              ...
                              //Inicia consulta de vehículo de las subastas
                              $res2 = $bd->select("SELECT * from vehiculo where id_vehiculo=$id_vehiculo");
                              if($res2->num_rows > 0){
                                while($row2 = $res2->fetch_assoc()){
                                  $marca_v = $row2["marca"];
