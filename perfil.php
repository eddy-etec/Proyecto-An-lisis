  ...
  <?php
    ...
    if(isset($_POST["guardar"])){
      ...
      if($foto == null){
        ...
        $res = $bd->query("UPDATE usuario set nombre='$nombre', primer_apellido='$primer_apellido', segundo_apellido='$segundo_apellido', edad='$edad',correo='$correo', user='$user', pass='$pass' where id_usuario=$id_usuario;");
        ...
        $res = $bd->query("UPDATE usuario set nombre='$nombre', primer_apellido='$primer_apellido', segundo_apellido='$segundo_apellido', edad='$edad',
